...
$user=array();
$con = mysqli_connect("localhost", "root", "","jl_market","3306");
$conn=new Conn();
...
{
    $db = new mysqli("localhost", "root", "", "jl_market", "3306");
...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark ">
    ...
    <div class="container ">
        <a href="#" class="navbar-brand">JL Market</a>
        <div class="d-flex">
...
<div class=" main_Container outline">
  ...
  width: 250px;"><?php
            ...
            ?></a></button>
    <img src="imgs/1.png" alt="" style="height: 100% ; width: 100%">
...
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    <div id="scrollspyHeading1" class="card" style="width: 18rem;">
        <img src="imgs/CC1.png" class="card-img-top" alt="..." style="height: 60%">
        <div class="card-body">
            <br>
            <br>
            <br>
            ...
            <a href="ComputerCases.php" class="btn btn-primary">Shop</a>
        </div>
    </div>
    <div id="scrollspyHeading1" class="card" style="width: 18rem;">
        <img src="imgs/CP1.png" class="card-img-top" alt="..." style="height: 50%">
        <div class="card-body">
            <br>
            <br>
            <h5 class="card-title">CPU</h5>
            <p class="card-text">Power the beast with the most powerfull CPUs on the market.</p>
            <a href="CPU.php" class="btn btn-primary">Shop</a>
        </div>
    </div>
    <div id="scrollspyHeading1" class="card" style="width: 18rem;">
        <img src="imgs/GCBK.png" class="card-img-top" alt="..."STYLE="height: 50%">
        <div class="card-body">
            <br>
            <br>
            ...
            <a href="GraphicsCards.php" class="btn btn-primary">Shop</a>
        </div>
    </div>
</div>
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    <div id="scrollspyHeading2" class="card" style="width: 18rem;">
        ...
        <div class="card-body">
            ...
            <a href="PoweSupply.php" class="btn btn-primary">Shop</a>
        </div>
    </div>
    <div id="scrollspyHeading2" class="card" style="width: 18rem;">
        <img src="imgs/mobile1.png" class="card-img-top" alt="..." style="height: 50%">
        <div class="card-body">
            <br>
            <br>
            <h5 class="card-title">Mobile Phone</h5>

            <p class="card-text">Any system of phones u can have with little price.</p>
            <a href="#" class="btn btn-primary">Shop</a>
        </div>
    </div>
    <div id="scrollspyHeading2" class="card" style="width: 18rem;">
        <img src="imgs/mono1.png" class="card-img-top" alt="..." style="height: 40%">
        <div class="card-body">
            <br>
            <br>
            <br>
            <h5 class="card-title">Computer Monitors</h5>
            <p class="card-text">The Window to view the content you NEEDED .</p>
            <a href="#" class="btn btn-primary">Shop</a>
        </div>
    </div>
</div>
<div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
    ...
    <div id="scrollspyHeading3" class="card" style="width: 18rem;">
        <img src="imgs/acc1.png" class="card-img-top" alt="..." style="height: 50%">
        <div class="card-body">
            <br>
            <br>
